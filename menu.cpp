...
void menuprincipal()
{
    ...
    case 2:
        ...
        svgout.addText(10,430,"Vanilla :","black");
        g.dessinerGraphSVG(svgout,10, 350);
        svgout.addText(440,100,"Prim 1 :","black");
        Prim1.dessinerGraphSVG(svgout,450, 0);
        svgout.addText(440,430,"Prim 2 :","black");
        Prim2.dessinerGraphSVG(svgout,450, 350);
        break;
