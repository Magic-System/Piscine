...
public:
    ...
    void addDisk(double x, double y, double r, std::string color=defcol, std::string id="node");
    ...
    void addLine(double x1, double y1, double x2, double y2, std::string color=defcol, std::string id="path", int opacity=1);
    void addLine(double x1, double y1, double x2, double y2, double thickness, std::string color, std::string id="path", int opacity=1);
    void addCross(double x, double y, double span, std::string color=defcol);

    void addAnimationOpacite(std::string idObj, std::string idBegin);

    void addText(double x, double y, std::string text, std::string color=defcol, int opacity=1);
    void addText(double x, double y, double val, std::string color=defcol, int opacity=1);
